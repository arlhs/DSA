...
public:
    ...
    vector<int> verticalOrder(Node *root)
    {
        ...
        // node 0, left of node -1 and right of node +1...
        map<int, vector<int>> verticalValue;
        ...
        while (!q.empty())
        {
            ...
            verticalValue[horizontalDist].push_back(current->data);
        ...
        vector<int> v;
        for (auto it = verticalValue.begin(); it != verticalValue.end(); it++)
        {
